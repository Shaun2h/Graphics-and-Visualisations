...
public:
	...
	void recur_down(Joint* inp, MatrixStack matty);
    ...
    void bindworldtojointrecur(Joint* rootjoint, MatrixStack stack);
    void Jointtoworldrecurupdate(Joint* joint, MatrixStack stack);
